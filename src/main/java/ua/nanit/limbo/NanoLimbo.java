...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "5e7203de-cd4c-41f2-b797-853c041974a8"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "mnhj.kdns.fr");        // argo固定隧道隧道域名
        ...
        envVars.put("REALITY_PORT", "25879");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
